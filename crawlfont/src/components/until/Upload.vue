<template>
  <div>
    ...
    <div class="container">
      ...
      <!--  todo button标签绑定的方法出发后却不能弹出下载，只返回了二进制流信息，神奇 -->
      <el-button type="primary" @click="download" size="small"
        >导出EXCEL</el-button>
      <el-upload class="upload-demo" drag :action="`${importApi}`" :http-request="upload" multiple>
...
import { downloadExcel,uploadExcel, apiBase } from "../../api/index";
